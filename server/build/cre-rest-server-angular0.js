...
app.get('/portfolios/:userID', function (req, res) {
...
app.get('/sectors/:portfolioName/:userID/:scenario/:shared', function (req, res) {
...
app.get('/scenarios/:portfolioName/:userID/:shared', function (req, res) {
...
app.get('/graphs/:portfolioName/:userID/:sector/:term/:shared', function (req, res) {
...
app.get('/mc/:portfolioName/:userID/:sector/:scenarioName/:interval/:shared', function (req, res) {
...
app.get('/portfolioComposition/:portfolioName/:userID/:sector/:shared', function (req, res) {
...
app.get('/summary/:portfolioName/:userID/:sector/:term/:shared', function (req, res) {
...
app.get('/summary1y/:portfolioName/:userID/:sector/:term/:shared', function (req, res) {
...
app.get('/loans/:userID/:portfolioName/:sector/:scenario/:sort/:shared', function (req, res) {
...
//# sourceMappingURL=cre-rest-server-angular0.js.map