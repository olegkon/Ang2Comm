...
app.get('/sectors/:portfolioName/:userID/:scenario/:shared', (req, res) => {  //OK: was: /portfolios/:id
...
app.get('/scenarios/:portfolioName/:userID/:shared', (req, res) => {  //OK: was: /portfolios/:id
...
app.get('/graphs/:portfolioName/:userID/:sector/:term/:shared', (req, res) => {  //OK: was: /portfolios/:id
...
app.get('/mc/:portfolioName/:userID/:sector/:scenarioName/:interval/:shared', (req, res) => {  //OK:
...
app.get('/portfolioComposition/:portfolioName/:userID/:sector/:shared', (req, res) => {
...
app.get('/summary/:portfolioName/:userID/:sector/:term/:shared', (req, res) => {  //OK: get credit summary
...
app.get('/summary1y/:portfolioName/:userID/:sector/:term/:shared', (req, res) => {  //OK: get 1yr summary
...
app.get('/loans/:userID/:portfolioName/:sector/:scenario/:sort/:shared', (req, res) => {  //OK: was: /portfolios/:id
...
function getPortfoliosFromDB1 (response, userID) {
    ...
    sql.connect(config, function (err) {
        ...
        request.on('row', function (row) {
            ...
            console.log("row: "+JSON.stringify(portfolio));
        });
